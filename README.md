...
2) опрос зарегистрированых пользователе на заданные вопросы, 
3) через админку можно задавать разные вопросы и ответы, везти баллы за правильные ответы,
4) реализовано подключение через django rest api,
